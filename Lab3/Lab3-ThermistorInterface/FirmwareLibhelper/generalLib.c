...
void ADC10_Init(void){
    ...
    ADC10CTL0 = ADC10ON | ADC10SHT_3;    // Long SHT; ADC ON
    ...
    ADC10MCTL0 = ADC10INCH_0 | ADC10SREF_0;  // A0 input, Vref+ = AVCC (≈3.3 V), Vref- = AVSS
...
unsigned int ADC10_Sample(unsigned char channel)
{
    ...
    // channel should be one of the ADC10INCH_x constants
    ADC10MCTL0 = (ADC10MCTL0 & ~ADC10INCH_15) | channel | ADC10SREF_0;
